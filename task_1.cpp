...
void FlightBooking::printStatus()
{
    ...
    if (capacity > 0) { // Перевірка, щоб уникнути ділення на нуль
        ...
        // Якщо місткість 0, але є заброньовані місця, можна вважати 100% або невизначеність,
        // але для уникнення помилок, краще обробити цей випадок.
        // У завданні не вказано, як обробляти capacity=0, тому виводимо 0% або можна вивести помилку.
        // Тут ми виведемо відсоток як 0, якщо capacity == 0.
        // Якщо потрібно інакше - змініть логіку.
        // Або, якщо завжди capacity > 0 згідно з логікою, цю перевірку можна спростити.
    }
